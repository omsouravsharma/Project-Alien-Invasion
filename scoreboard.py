...
class Scoreboard:
    """A class to report the scoring infomation"""
    ...
    def __init__(self, ai_game):
        ...
        # Font settting for score information
    ...
    def prep_high_score(self):
        """Turned the hgh score in renedered image"""
    ...
    def prep_level(self):
        ...
        self.leve_image = self.font.render(
            level_str, True, self.text_color, self.settings.bg_color)

        # Display the position below the score
