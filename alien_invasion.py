...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create an instance to the store game statistics
    ...
    def _check_bullet_alien_collisions(self):
        """Respond to bullet_alien_collisions."""
        # Remove any bullets and aliens that have collided.
        # Check for any bullet that hvae hit alien
        # If yes remve alien and bullet
    ...
    def _check_aliens_bottom(self):
        """Check if any aleiends have reached the bottom of the scrren"""
        screen_rect = self.screen.get_rect()
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat same way as if the ship bot hit/
                self._ship_hit()
                break
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Create a new fleet and center the shop
            self._create_fleet()
            self.ship.center_ship()
